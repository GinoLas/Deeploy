...
from Deeploy.Targets.Generic.Templates import CryptoTemplate,AllocateTemplate as BasicAllocateTemplate
...
CryptoMapper = NodeMapper(CryptoParser(),BasicCryptoBindings)
