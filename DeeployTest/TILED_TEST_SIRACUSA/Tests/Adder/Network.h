...
static const uint32_t DeeployNetwork_MEMORYARENA_L1_len = 750;
extern int8_t *DeeployNetwork_MEMORYARENA_L2;
static const uint32_t DeeployNetwork_MEMORYARENA_L2_len = 750;
...
#define LOG2_BUF_SIZE 1024
extern PI_L2 char log2_buffer[LOG2_BUF_SIZE];
extern volatile int log2_index;
