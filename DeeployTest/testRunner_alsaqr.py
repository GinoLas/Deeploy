...
if __name__ == "__main__":
    ...
    parser = TestRunnerArgumentParser(
        ...
        description = "Deeploy Code Generation Utility for the AlSaQr Platform (no Tiling).")
    ...
    testRunner = TestRunner(platform = "AlSaQr", simulator = "none", tiling = False, argument_parser = parser)
